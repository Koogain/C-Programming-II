/* 파일명: Assignmment_14.c
   ...
   내용: 13번 프로그램을 실행해서 크기가 다른 2진 파일을 2개 생성한 다음 두 파일을 읽어서 하나의 int 배열을 생성한 다음 정렬 후에 다시 2진 파일로 저장하는 프로그램을 작성하시오.
...
/* 이진 파일 읽기: [int N][int 값 N개] 형식
   성공 시 *out_arr 에 동적 할당한 배열 주소, *out_n 에 개수 반환 */
